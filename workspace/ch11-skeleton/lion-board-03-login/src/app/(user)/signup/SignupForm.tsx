  ...
  return (
    <form action={formAction}>
      ...
      <div className='mb-4'>
        ...
        <input type='text' id='name' autoComplete='name' placeholder='이름을 입력하세요' className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-orange-400 dark:bg-gray-700' name='name' />
      ...
      <div className='mb-4'>
        ...
        <input type='email' id='email' autoComplete='username' placeholder='이메일을 입력하세요' className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-orange-400 dark:bg-gray-700' name='email' />
      ...
      <div className='mb-4'>
        ...
        <input type='password' id='password' autoComplete='new-password' placeholder='비밀번호를 입력하세요' className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-orange-400 dark:bg-gray-700' name='password' />
      ...
      <div className='mb-4'>
        ...
        <input type='file' id='attach' accept='image/*' placeholder='이미지를 선택하세요' className='w-full px-3 py-2 border rounded-lg dark:bg-gray-700' name='attach' />
      </div>
      ...
      <div className='mt-10 flex justify-center items-center'>
        ...
        <Link href='/' className='bg-gray-900 py-1 px-4 text-base text-white font-semibold ml-2 hover:bg-amber-400 rounded'>
          취소
        </Link>
      </div>
    </form>
