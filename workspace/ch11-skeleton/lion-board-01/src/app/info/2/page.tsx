...
<html lang="ko">
  <head>
    ...
    <title>Next.js란? - Lion Board</title>
    ...
    <meta property="og:title" content="Next.js란?" />
    <meta property="og:description" content="Next.js는 React 기반의 풀스택 웹 프레임워크로..." />
          ...
          <nav className="flex flex-wrap justify-center items-center p-4 md:flex-nowrap md:justify-between">
            ...
            <div className="w-auto order-2 text-base mt-4 md:mt-0">
              <ul className="flex items-center gap-6 uppercase">
                ...
                <li className="hover:text-amber-500 a:font-semibold"><a href="/info">질문게시판</a></li>
              </ul>
            </div>
